...
import models.daos.InMemoryPasswordDao
...
/**
  ...
  */
trait SilhouetteModule extends AuthenticatorServiceModule with UserServiceModule with AuthInfoServiceModule with CredentialsProviderModule {

  lazy val eventBus = EventBus()
  lazy val idGenerator = new SecureRandomIDGenerator
  lazy val authInfoDAO = new InMemoryPasswordDao
